#!/usr/bin/env python3
"""
Evolution Gaming Roulette Results Collector (Simplified)
Main application file - works without OCR dependencies
"""
...
from roulette_detector_simple import RouletteDetectorSimple
from discord_notifier import DiscordNotifier
from local_html_client import LocalHTMLClient
from roulette_result import RouletteResult

class RouletteCollectorSimple:
    """Simplified roulette results collector application"""
    
    def __init__(self):
        self.detector = RouletteDetectorSimple()
    ...
    def start(self) -> bool:
        ...
        try:
            self.logger.info("Starting Roulette Results Collector (Simplified)...")
...
def main():
    """Main entry point"""
    print("🎰 Evolution Gaming Roulette Results Collector (Simplified)")
    print("=" * 60)
    
    collector = RouletteCollectorSimple()
